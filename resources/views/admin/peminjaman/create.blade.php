...
:root{--pink:#f9a8d4;--blue:#a5d8ff;--mint:#a7f3d0;--border:#e5e7eb}
...
.input,select.input{width:100%;height:42px;padding:10px 12px 10px 38px;border-radius:10px;border:1.5px solid var(--border);background:#fafafa}
