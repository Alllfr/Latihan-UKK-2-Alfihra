...
.form-group{width:100%;margin-bottom:4px}
...
<div class="title">👨‍🎓 Edit Siswa</div>
...
<input class="input" name="name" value="{{ $siswa->name }}">
</div>
</div>
...
<div class="input-wrap">
<span class="icon">🆔</span>
<input class="input" name="nis" value="{{ $siswa->nis }}">
</div>
</div>
...
<div class="input-wrap">
<span class="icon">🏫</span>
<input class="input" name="kelas" value="{{ $siswa->kelas }}">
</div>
</div>
