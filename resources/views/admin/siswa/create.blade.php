...
<div style="text-align:center;font-weight:700;font-size:20px;">👨‍🎓 Tambah Siswa</div>

<form method="POST" action="{{ route('admin.siswa.store') }}" id="form">
@csrf

<label class="label">Nama</label>
<div class="input-wrap"><span class="icon">👤</span><input class="input" name="name"></div>

<label class="label">NIS</label>
<div class="input-wrap"><span class="icon">🆔</span><input class="input" name="nis"></div>

<label class="label">Kelas</label>
<div class="input-wrap"><span class="icon">🏫</span><input class="input" name="kelas"></div>
